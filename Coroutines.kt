...
//Use these functions in the main function to compare results:
...
fun exampleAsyncAwait() = runBlocking {
    ...
    val deferred3 = async { calculateHardThings(40) }
...
fun exampleWithContext() = runBlocking {
    ...
    val result3 = withContext(Dispatchers.Default) { calculateHardThings(40) }
